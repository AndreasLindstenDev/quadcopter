...
toroidal_propeller(
    ...
    hub_height = 9,                 // Hub height | Default(6)
    hub_d = 16,                     // hub diameter | Default(16)
    hub_screw_d = 4.9,              // hub screw diameter | Default(5.5)
    hub_notch_height = 0,           // height for the notch | Default(0 = [No support]) 1.6
    hub_notch_d = 0                 // diameter for the notch | Default(0 = [No support]) 9.3
);
